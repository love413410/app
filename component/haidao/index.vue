		...
		<view class="data-list" v-for="(item,index) in list" v-if="list.length>0">
			...
			<view class="list-center">
				<view class="list-item">
					...
					<view class="item-rt">{{item.el_lg}}m</view>
				</view>
				<view class="list-item">
					<view class="item-lt">
					...
					<view class="item-rt">{{item.el_hw}}°C</view>
				</view>
				<view class="list-item">
					<view class="item-lt">
					...
					<view class="item-rt">{{item.el_sc}}km</view>
				</view>
				<view class="list-item">
					<view class="item-lt">
					...
					<view class="item-rt">{{item.el_tq}}</view>
				</view>
			</view>
